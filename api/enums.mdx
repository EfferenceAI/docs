...
| Value | Meaning |
|---|---|
| `CORRUPTED_FRAME` | frame incomplete or failed to decode |
...
| `MOTION_STATE` | `STATIC`, `MOVING`, `FALLING` | on-device IMU classification (ZUPT / free-fall) |
...
| `SENSORS_UNIT` | `M_SEC_2`, `DEG_SEC`, `CELSIUS`, `HERTZ` | |
