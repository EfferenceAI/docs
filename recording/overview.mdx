...
<Note>
  ...
  against it. Auto-exposure convergence moves with tuning, and a recent bench
  check came in well under them, so treat them as an upper bound rather than as
  what your device will do. Measure your own scene if the margin matters.
</Note>
