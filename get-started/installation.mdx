...
<Steps>
  ...
  <Step title="Verify the installation">
    ...
    `ef list` should discover the connected M1. `ef info` prints its serial,
    firmware version, capture modes, camera configuration, IMU parameters,
    and wireless status.
  </Step>
</Steps>
...
| Tool | Purpose |
|---|---|
| `ef` | Device discovery, configuration, health, recording, WiFi, and updates |
